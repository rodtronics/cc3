...
// make one event listener across whole gizmo wrapper
let crimeGizmoWrapperElement = document.getElementById("crimeGizmoWrapper_ID");
...
function addNewGizmoToWrapper(index) {
